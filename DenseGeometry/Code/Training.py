...
if __name__ == '__main__' and not TestingThings:
    ...
    if not DoNotTrain:
        ...
        from Model_SDP_NLRE_and_Regression import Model_SDP_NLRE_and_Regression_RawLogits_SDPThetaOnly , Model_SDP_NLRE_and_Regression_RawLogits_SDPPhiOnly
        Models = [
            # Model_SDP_NLRE_and_Regression_RegressionOnly,
            Model_SDP_NLRE_and_Regression_RawLogits_SDPThetaOnly,
            Model_SDP_NLRE_and_Regression_RawLogits_SDPPhiOnly
        ]
