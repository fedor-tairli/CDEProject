...
class Model_SDP_LSTM(nn.Module):
    Name = 'Model_SDP_LSTM'
    Description = '''
    LSTM Architecture for SDP Reconstruction
    Uses standad LSTM layers
    '''

    def __init__(self,in_main_channels = (3,2,), N_LSTM_nodes = 32,N_LSTM_layers=5 ,N_dense_nodes = 128, **kwargs):
        ...
        super(Model_SDP_LSTM, self).__init__()
...
class Model_SDP_LSTM_JustTheta(Model_SDP_LSTM):
    Name = 'Model_SDP_LSTM_JustTheta'
    Description = '''
    ...
    def __init__(self,in_main_channels = (3,2,), N_LSTM_nodes = 32,N_LSTM_layers=5 ,N_dense_nodes = 128, **kwargs):
        super(Model_SDP_LSTM_JustTheta, self).__init__(in_main_channels=in_main_channels, N_LSTM_nodes=N_LSTM_nodes, N_LSTM_layers=N_LSTM_layers, N_dense_nodes=N_dense_nodes, **kwargs)
        self.OutWeights = torch.tensor([1, 0])

class Model_SDP_LSTM_JustPhi(Model_SDP_LSTM):
    Name = 'Model_SDP_LSTM_JustPhi'
    Description = '''
    Convolutional Neural Network for SDP Reconstruction
    ...
    def __init__(self, in_main_channels=(3, 2,), N_LSTM_nodes=32, N_LSTM_layers=5, N_dense_nodes=128, **kwargs):
        super(Model_SDP_LSTM_JustPhi, self).__init__(in_main_channels=in_main_channels, N_LSTM_nodes=N_LSTM_nodes, N_LSTM_layers=N_LSTM_layers, N_dense_nodes=N_dense_nodes, **kwargs)
