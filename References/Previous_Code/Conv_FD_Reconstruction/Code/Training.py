...
ModelPath = '/remote/tychodata/ftairli/work/Projects/Conv_FD_Reconstruction/Models/'
...
if __name__ == '__main__':
    ...
    LoadModel            = False
    DoNotTrain           = False
    DatasetName          = 'Conv_SingleTelescope_Axis_Dataset' #No / or .pt JUST NAME, eg GraphStructure  Use None to save as default
    ...
    # Save Paths
    SavePath     = '/remote/tychodata/ftairli/work/Projects/Conv_FD_Reconstruction/Models/'
    plotSavePath = '/remote/tychodata/ftairli/work/Projects/Conv_FD_Reconstruction/Results/TrainingPlots/'
    ...
    Path_To_Proc_Data = '/remote/tychodata/ftairli/work/Projects/Conv_FD_Reconstruction/Data/'
    ...
    if not DoNotTrain:
        ...
        from Model_Axis_Conv import Loss as Loss_function
        from Model_Axis_Conv import validate, metric
        from Model_Axis_Conv import Model_Axis_Conv_3d_JustX, Model_Axis_Conv_3d_JustY, Model_Axis_Conv_3d_JustZ, Model_Axis_Conv_3d_JustSDPPhi, Model_Axis_Conv_3d_JustCEDist

        # Models = [Model_XmaxE_Conv_3d_Distances_JustXmax, Model_XmaxE_Conv_3d_Distances_JustLogE]
        Models = [Model_Axis_Conv_3d_JustCEDist]
