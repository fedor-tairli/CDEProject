...
# from Model_Axis_Conv import Model_Axis_Conv_3d_JustXmax_NoStation, Model_Axis_Conv_3d_JustLogE_NoStation, Model_Axis_Conv_3d_JustAxis_NoStation, Model_Axis_Conv_3d_JustSDPPhi_NoStation#, Model_Axis_Conv_3d_JustCEDist_NoStation
...
if __name__ == '__main__':
    ...
    if not DoNotTrain:
        ...
        from Model_XmaxE_Conv import Model_XmaxE_Conv_3d_Distances_JustXmax, Model_XmaxE_Conv_3d_Distances_JustLogE

        # Models = [Model_XmaxE_Conv_3d_Distances_JustXmax, Model_XmaxE_Conv_3d_Distances_JustLogE]
        Models = [Model_XmaxE_Conv_3d_Distances_JustLogE]
