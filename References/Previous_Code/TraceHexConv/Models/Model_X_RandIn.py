...
class Model_X_RandIn(nn.Module):

    def __init__(self):
        super(Model_X_RandIn, self).__init__()

        # Info
        self.Name = 'Model_X_RandIn'
        self.Description ='''
        Testing the behaviour of the model if i input random Xmax as input
        '''
