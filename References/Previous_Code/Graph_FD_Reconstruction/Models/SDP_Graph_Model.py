...
class Model_SDP_Graph(nn.Module):
    Name = 'Model_SDP_Graph'
    Description = '''
    ...
    def __init__(self,in_node_channels = 4, in_edge_channels = 2, N_kernels = 32, N_heads = 4, N_dense_nodes = 128, **kwargs):
        ...
        super(Model_SDP_Graph, self).__init__()
...
class Model_SDP_Graph_JustTheta(Model_SDP_Graph):
    Name = 'Model_SDP_Graph_JustTheta'
    Description = '''
    Graph Neural Network for SDP Reconstruction
    Uses GATConv for the Graph Convolution
    ...
    def __init__(self,in_node_channels = 4, in_edge_channels = 2, N_kernels = 32, N_heads = 4, N_dense_nodes = 128, **kwargs):
        super(Model_SDP_Graph_JustTheta, self).__init__(in_node_channels = in_node_channels, in_edge_channels = in_edge_channels, N_kernels = N_kernels, N_heads = N_heads, N_dense_nodes = N_dense_nodes, **kwargs)
        self.OutWeights = torch.tensor([1,0])



class Model_SDP_Graph_JustPhi(Model_SDP_Graph):
    Name = 'Model_SDP_Graph_JustPhi'
    Description = '''
    Graph Neural Network for SDP Reconstruction
    Uses GATConv for the Graph Convolution
    ...
    def __init__(self,in_node_channels = 4, in_edge_channels = 2, N_kernels = 32, N_heads = 4, N_dense_nodes = 128, **kwargs):
        super(Model_SDP_Graph_JustPhi, self).__init__(in_node_channels = in_node_channels, in_edge_channels = in_edge_channels, N_kernels = N_kernels, N_heads = N_heads, N_dense_nodes = N_dense_nodes, **kwargs)
