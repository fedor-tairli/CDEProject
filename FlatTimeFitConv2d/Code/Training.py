...
def LoadProcessingDataset(Path_To_Data,Path_To_Proc_Data,RunNames,RecalculateDataset = False,NeedTraces = False,OptionalName = None):
    ...
    if RecalculateDataset:
        ...
        # Order is fastest to slowest probably, for bugs ...
...
if __name__ == '__main__' and not TestingThings:
    ...
    DoNotTrain           = False
    DatasetName          = 'FlatTimeFit_Dataset' #No / or .pt JUST NAME, eg GraphStructure  Use None to save as default
    ...
    if not DoNotTrain:
        # import model
        from TrainingModule2 import Train , Tracker

        
        from Model_FlatTimeFit_Conv2d import Loss_class as Loss_function
        from Model_FlatTimeFit_Conv2d import Validate_class as validate
