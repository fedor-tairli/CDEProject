...
Pass_Main     = FlatTimeFit_Conv2d_DataGen.Graph_FlatTimeFit

Pass_Aux      = FlatTimeFit_Conv2d_DataGen.Aux_Descriptors

Pass_Truth    = FlatTimeFit_Conv2d_DataGen.Truth_Rec_Time_Fit
